...
// callback é um resultado anterior, como se alguem estivesse aguardando um retorno.
...
let saudacao = (nome, idade) => {
    ...
    let mensagem2 = `Olá, meu nome é ${nome} e eu tenho ${idade} anos.`;
    let mensagem3 = mensagem + '\n' + mensagem2; // maneira opcional
    return mensagem + '\n' + mensagem2 + '\n' + mensagem3;  
};
// Chamando a função e exibindo o resultado no console
console.log (saudacao('Thaís',34));